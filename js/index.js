...
(function setupHeroVideo() {
  ...
  const tryPlay = () =>
    v.play().catch(() => {
      /* ignore gesture gate; will retry */
    });
...
(function setupAboutReveal() {
  ...
  section
    .querySelectorAll(".about-divider, .about-mark")
  ...
  function getAnim(el) {
    return animations.get(el) || makeAnimation(el);
  }
  function play(el) {
    const a = getAnim(el);
  ...
  const io = new IntersectionObserver(
    ...
    {
      threshold: [0, 0.02, 0.1, 0.18, 0.25, 0.5, 0.75, 1],
